...
function Create-Users {
    ...
    # Detectar nombre real del grupo Administradores (idioma independiente)
    $groups = net localgroup
    $adminGroup = ($groups | Where-Object { $_ -match "Admin" })[0].Trim()
    ...
    foreach ($u in $users) {
        ...
        try {
            ...
            # Password nunca expira (compatible PS 5.1)
